...
{
    public class EssentialsMinimalRoomPanelAvFunctionsDriver : PanelDriverBase
    {
        /// <summary>
        ...
        public EssentialsMinimalRoomPanelAvFunctionsDriver(PanelDriverBase parent, CrestronTouchpanelPropertiesConfig config)
            : base(parent.TriList)
        {
            Config = config;
            Parent = parent;
            ...
            OnlineButtonSig = TriList.BooleanInput[EssentialsMinimalRoomJoins.OnlineButtonVisible];
            //OnlineButtonSig.BoolValue = true;
            TriList.SetBool(EssentialsMinimalRoomJoins.OnlineButtonVisible, true);

            // toggle a button (inc feedback)
            ToggleButtonSig = TriList.BooleanInput[EssentialsMinimalRoomJoins.ToggleButtonPress];
            TriList.SetSigFalseAction(EssentialsMinimalRoomJoins.ToggleButtonPress, ToggleButtonPress);
            ...
            PowerButtonSig = TriList.BooleanInput[EssentialsMinimalRoomJoins.PowerButtonPress];
        ...
        public void ToggleButtonPress()
        {
            ...
            TriList.SetBool(EssentialsMinimalRoomJoins.ToggleButtonPress, !ToggleButtonSig.BoolValue);
        ...
        public void PowerButtonPress()
        {
            ...
            TriList.SetBool(EssentialsMinimalRoomJoins.PowerButtonPress, !PowerButtonSig.BoolValue);
        }
    }
}